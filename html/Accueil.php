...
<div id="Header">
	<div id="Traduit">
		...
		<a href="version_anglaise/Accueil.php"><img src="../cover/anglais.png" alt="anglais"></a>
...
<!--Fin Menu-->
<div id="Content">
	<h1 class="titre_principal">Bienvenue sur le site du R&amp;T:Malaisie</h1>
	<div id="banner">
	...
	<div id="column">
		<div id="news">
		<strong>Toute l'actualit&eacute;</strong>
		<p>Bonne chance à tous pour les DS prochains!</p>
		<p>Bienvenue au deuxi&egrave;me semestre.</p> 
		</div>
	<div id="citation">
		<strong>Perles de sagesse</strong>
