...
<div id="header-wrapper">
	<div id="header" class="container">
		<div id="menu">
			<ul>
				...
				<li class='current_page_item'><a href='vietudiant.php' accesskey='5' title=''>VIE &Eacute;TUDIANTE</a></li>
	...
	<div id="traduit">
			...
			<a href="en/vietudiant.php"><img src="../cover/anglais.png" alt="anglais"></a>
	</div>
</div>
<div id="wrapper1">
...
<div id="wrapper3">
	...
	<div id="wrapper-blog" class="container">
		...
		<div id="post">
			<div class="post"> <span class="date"></span>
				<h2><strong>Salles à l'IUT</strong></h2>
				<p>
					<ul>
			...
			<div class="post"><span class="date"></span>
				<h2><strong>L'Environnement</strong></h2>
				<p>Le site de R&T se trouve dans l'agglomération de Sophia Antipolis à Valbonne. Le nouveau quartier Saint-Philippe est situé près du departement où nous pouvons trouver des diverses commerces dont un supermarché Casino. Il est possible d'y aller à pied depuis le site du departement.	 	
					<br><br><img src="../cover/VieEtudiant.jpg" alt="casino sophia">  <img src="../cover/VieEtudiant2.jpg" alt="l'entree de l'iut">
				</p>
			</div>
			<div class="post"> <span class="date"></span>
				<h2><strong>La Circulation</strong></h2>
				<p>En ce qui nous concerne, nous les &eacute;tudiants malaisiens, le meilleur moyen de transport est sans doute le bus. Les lignes du r&eacute;seau Envibus et celui de Lignes d'Azur nous permettent de circuler &agrave; Valbonne et les villes voisines (Antibes et Nice) sans difficult&eacute;.
	...
	&diams;&nbsp; &nbsp;Vous pouvez trouver plus d'informations sur le site du <a href="http://www.cg06.fr/fr/servir-les-habitants/deplacements/transport-collectifs/transports-collectifs/">Conseil G&eacute;n&eacute;ral</a>. Nous avons aussi la possibilit&eacute; de profiter du covoiturage, ce qui est le transport en commun le plus utilis&eacute; par les &eacute;tudiants en g&eacute;n&eacute;ral.
	 ...
	 &diams; &nbsp; &nbsp; Plus d'informations sur le site <a href="http://www.envibus.fr/">Envibus</a>.
			...
			<div class="post no-border"> <span class="date"></span>
				<h2><strong>L'H&Eacute;BERGEMENT</strong></h2>
				<p>Il y a beaucoup de r&eacute;sidences universitaire qui nous conviennent dont :<br><br>
	...
	&diams;&nbsp; &nbsp;Situ&eacute;e &agrave; Nice, 25 rue Robert Latouche (06200)<br>
